...
public class Ask {
    ...
    public static Dragon askDragon(Console console) throws AskBreak {
        try {
            ...
            return new Dragon(1, name, SessionHandler.getSession().getUsername(), coordinates, LocalDateTime.now(), age, speaking, color, character, killer);
    ...
    private static Person askPerson(Console console) throws AskBreak {
        ...
        location = askLocation(console);

        return new Person(-1, name, birthday, height, weight, location);
    }
    ...
    private static Location askLocation(Console console) throws AskBreak {
        ...
        return new Location(-1, x, y, z);
    }

    public static User askUser(Console console) throws AskBreak {
        String username = askString(console, "Enter username: ", true);
        String password = askString(console, "Enter password: ", true);
