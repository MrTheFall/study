...
public class Dragon extends Element implements Comparable<Dragon>, Serializable {
    ...
    private LocalDateTime creationDate; // Генерация даты создания
    private int age;
     ...
     */
    public Dragon(int id, String name, String ownerUsername, Coordinates coordinates, LocalDateTime creationDate, int age, Boolean speaking, Color color, DragonCharacter character, Person killer) {
        this.id = id;
        this.name = name;
        this.ownerUsername = ownerUsername;
        this.coordinates = coordinates;
        this.creationDate = creationDate; // Автоматическая генерация даты создания
        this.age = age;
    ...
    public Dragon() {
        ...
        this.creationDate = null; // Автоматическая генерация даты создания
        this.age = -1;
        this.speaking = null;
        this.color = null;
        this.character = null;
